...
<script>
  ...
  const setStatus = msg => { const s = $('status'); s.textContent = msg; };
  ...
  function renderResults(items) {
    ...
    items.forEach(item => {
      ...
      li.innerHTML = `<a href="https://www.youtube.com/watch?v=${videoId}" target="_blank">${title}</a> - Publicado: ${published}`;
      ul.appendChild(li);
    });
  }
  ...
  // Búsqueda inicial para mostrar resultados en blanco
